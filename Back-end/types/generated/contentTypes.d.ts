...
export interface ApiDetalleCarritoDetalleCarrito
  extends Struct.CollectionTypeSchema {
  collectionName: 'detalles_carritos';
  info: {
    displayName: 'DetalleCarrito';
    pluralName: 'detalles-carritos';
...
export interface ApiDetalleVentaDetalleVenta
  extends Struct.CollectionTypeSchema {
  collectionName: 'detalles_ventas';
  info: {
    displayName: 'DetalleVenta';
    pluralName: 'detalles-ventas';
...
export interface ApiDireccionUsuarioDireccionUsuario
  extends Struct.CollectionTypeSchema {
  collectionName: 'direcciones_usuarios';
  info: {
    displayName: 'DireccionUsuario';
    pluralName: 'direcciones-usuarios';
    singularName: 'direccion-usuario';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::direccion-usuario.direccion-usuario'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiDireccionDireccion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    calle: Schema.Attribute.Text & Schema.Attribute.Required;
    cp: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    direccion_usuarios: Schema.Attribute.Relation<
      'oneToMany',
      'api::direccion-usuario.direccion-usuario'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imagen: Schema.Attribute.Media & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    material: Schema.Attribute.Enumeration<['Jean', 'Algod\u00F3n', 'Lino']> &
      Schema.Attribute.Required;
    nombre: Schema.Attribute.String & Schema.Attribute.Required;
    precio: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    promo_productos: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPromoProductoPromoProducto
  extends Struct.CollectionTypeSchema {
  collectionName: 'promos_productos';
  info: {
    displayName: 'PromoProducto';
    pluralName: 'promos-productos';
    singularName: 'promo-producto';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPromoPromo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    descuento: Schema.Attribute.Integer &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    fechaFin: Schema.Attribute.DateTime & Schema.Attribute.Required;
    fechaInicio: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
