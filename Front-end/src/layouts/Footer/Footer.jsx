    ...
    <footer className="footer">
      ...
      <div className="footer-left">
        ...
        <div className="footer-newsletter">
          ...
          <BlueButton width="220px"height="36px" fontSize="15px">Enviar</BlueButton>
        </div>
      ...
      <div className="footer-right">
        ...
        <LinkButton><strong>PREGUNTAS FRECUENTES</strong></LinkButton>
        <LinkButton><strong>SOBRE NOSOTROS</strong></LinkButton>
      </div>
